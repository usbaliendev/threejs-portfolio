...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 border-b border-[#ffffff50] shadow-[0_4px_30px_rgba(250, 250, 250, 0)] backdrop-blur-[5px] bg-[#ffffff00]
      }`}>
