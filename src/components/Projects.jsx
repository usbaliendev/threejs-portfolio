...
import { github, linkgif } from "../assets";
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p
          className={`${styles.sectionSubText} text-center drop-shadow-[1px_1px_0px_#000]`}>
          Meus projetos
        </p>
      ...
      <div className='w-full flex'>
        <motion.p
          ...
          className=' text-secondary drop-shadow-[1px_1px_0px_#000] text-[17px] max-2-3x1 leading-[30px] text-justify'>
